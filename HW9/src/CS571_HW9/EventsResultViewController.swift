//
//  EventsResultViewController.swift
//  CS571_HW9
//
...
class EventsResultViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    var jsonData : JSON? {
        ...
        didSet{
            ...
            for (_, subJson):(String, JSON) in jsonData!["event"]["data"] {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let trueIndex = indexPath.row + page*10
        let parameters: Parameters = ["id": userDataArray[trueIndex].id!, "type": "event"]
