//
//  UsersResultViewController.swift
//  CS571_HW9
//
...
//        button.addTarget(self, action: #selector(onFavoriteButtonTapped), for: .touchUpInside)
//        return button
//        
//    }()
    ...
    lazy var favoriteButton : UIImageView = {
...
//        star.image = #imageLiteral(resourceName: "empty")
    ...
    lazy var nameTextLable : UILabel = {
    ...
    func setupViews(){
        ...
        contentView.addSubview(nameTextLable)
        contentView.addSubview(favoriteButton)
        
        userImg.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 20).isActive = true
        userImg.heightAnchor.constraint(equalToConstant: 40).isActive = true
        userImg.widthAnchor.constraint(equalTo: userImg.heightAnchor).isActive = true
        userImg.centerYAnchor.constraint(equalTo: contentView.centerYAnchor).isActive = true
        
        nameTextLable.leftAnchor.constraint(equalTo: userImg.rightAnchor, constant: 20).isActive = true
        nameTextLable.centerYAnchor.constraint(equalTo: contentView.centerYAnchor).isActive = true
        nameTextLable.rightAnchor.constraint(equalTo: favoriteButton.leftAnchor, constant: -10).isActive = true
        ...
        favoriteButton.rightAnchor.constraint(equalTo: contentView.rightAnchor).isActive = true
...
//        }
//        
////        delegate?.favoritedAt(cellTag: self.cellTag ?? nil)
//        
...
//    func setFavorited(){
//        favoriteButton.setImage(#imageLiteral(resourceName: "filled"), for: .normal)
//    }
//    
//    func unFavorited(){
//         favoriteButton.setImage(#imageLiteral(resourceName: "empty"), for: .normal)
//    }

}


class UsersResultViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
//    SearchResultTableViewCellDelegate {
    ...
    var jsonData : JSON? {
        ...
        didSet{
            ...
            for (_, subJson):(String, JSON) in jsonData!["user"]["data"] {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let trueIndex = indexPath.row + page*10
        let parameters: Parameters = ["id": userDataArray[trueIndex].id!, "type": "user"]
