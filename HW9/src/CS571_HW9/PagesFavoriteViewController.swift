//
//  PagesFavoriteViewController.swift
//  CS571_HW9
//
...
class PagesFavoriteViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let parameters: Parameters = ["id": favoritesArray![indexPath.row].id!, "type": "page"]
