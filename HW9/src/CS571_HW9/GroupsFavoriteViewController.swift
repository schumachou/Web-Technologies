//
//  GroupsFavoriteViewController.swift
//  CS571_HW9
//
...
class GroupsFavoriteViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let parameters: Parameters = ["id": favoritesArray![indexPath.row].id!, "type": "group"]
